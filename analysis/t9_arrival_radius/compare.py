...
Writes comparison.md next to this file. Usage: python analysis/t9_arrival_radius/compare.py
"""
import re, os, math
...
rows = ["# T9 sweep comparison — baseline (aefebc7: walks projected to the target point) vs new (HEAD: walks end at the body's arrival radius)", "",
